...
Item Giver Mode adds a standalone debug-style inventory browser. Press **F8** outside battle to browse and grant every named item definition available in the current chapter.
...
- Debug Mode v4.01 compiled successfully before and after Item Giver Mode in Chapters 1–5.
...
- Applying Item Giver Mode twice produced byte-identical chapter files.
